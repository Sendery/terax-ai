...
src-tauri/                  Rust backend
  src/
    ...
    modules/
      ...
      agent_cli.rs          CLI coding-agent process management
      capture.rs            Visual capture persistence
      ...
      slotmonit.rs          slot-monit shell helper bridge
      pi.rs                 Pi Terax bridge (TCP discovery + NDJSON transport)
...
src/                        React frontend
  ...
  modules/
    ...
    capture/                In-app visual capture
    commands/               Typed frontend command registry
    ...
    notes/                  Notes panel and floating notes window
    ...
    slot-monitor/           Status-bar health bulb for slot-monit
...
packages/
  pi-terax/               First-party Pi package (@crynta/pi-terax)
```
